...
[CreateAssetMenu(fileName = "FlyweightSettings", menuName = "Flyweight/FlyweightSettings")]
public class FlyweightSettings : ScriptableObject
{
    ...
    public Flyweight Create()
    {
        ...
        var flyweight = obj.AddComponent<Flyweight>();
        ...
        flyweight.settings.intrinsicDataArray = intrinsicDataArray;
